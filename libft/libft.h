...
/*   Updated: 2026/02/20 00:32:49 by alex             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					ft_conversion_manag(char const *format, int *i,
						va_list list);
int					ft_printf(const char *format, ...);
int					check_flags(char c, t_flags *flag);
int					ft_free_conversion(t_flags *flag, t_data *data,
						char *res, int len);
void				priority_flags(t_flags *flag);
int					data_fail(t_flags *flag, char c);
void				parse_flag(t_flags *flag, char const *str, int *j,
						va_list list);
void				parse_width(t_flags *flag, char const *str, int *j,
						va_list list);
void				parse_precision(t_flags *flag, char const *str, int *j,
						va_list list);
...
void				final_print(t_flags *flag, t_data *data, char *res,
						int *len);
...
char				*manag_prefix(char *str, t_data *data, t_flags *flag,
						char c);
